...
class _PerfilTabState extends State<PerfilTab> {
  ...
  Future<void> _subirFotoUsuario() async {
          ...
          child: Wrap(
            children: [
              ...
              ListTile(
                ...
                onTap: () {
                  sourceSeleccionado = ImageSource.gallery;
                  Navigator.pop(ctx);
                },
              ),
              ListTile(
                ...
                onTap: () {
                  sourceSeleccionado = ImageSource.camera;
                  Navigator.pop(ctx);
                },
              ),
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text("Subiendo imagen de perfil...")),
      );
  ...
  Future<void> _editarInfoPaseador(BuildContext context) async {
    final expController = TextEditingController(
      text: widget.userData['walker_info']?['experiencia'] ?? "",
    );
    final bioController = TextEditingController(
      text: widget.userData['walker_info']?['biografia'] ?? "",
    );
            ...
            children: [
              TextField(
                ...
                decoration: const InputDecoration(
                  labelText: "Experiencia (ej: 3 años)",
                ),
              ),
            ...
            onPressed: () async {
              try {
                ...
                if (res.statusCode == 200) {
                  setState(() {
                    widget.userData['walker_info']['experiencia'] =
                        expController.text;
                    widget.userData['walker_info']['biografia'] =
                        bioController.text;
                  });
          ...
          children: [
                ...
                child: Stack(
                  ...
                  children: [
                    CircleAvatar(
                      ...
                      backgroundImage:
                          (userData['foto'] != null &&
                              userData['foto'].toString().trim().isNotEmpty)
                          ? MemoryImage(base64Decode(userData['foto']))
                          : null,
                      child:
                          (userData['foto'] == null ||
                              userData['foto'].toString().trim().isEmpty)
                          ? Icon(
                              Icons.person,
                              color: Theme.of(context).colorScheme.primary,
                              size: 60,
            ...
            if (userData['es_paseador'] == true) ...[
              ...
              ListTile(
                ...
                subtitle: Text(
                  userData['walker_info']?['experiencia'] ??
